...
#
# ~~~~~SN1885~~~~~~~~
# Flux limit = 0.0027 mJy
# Beam size = 1 arcsec, 3.81 pc (at M31)
# Distance to m31 = 0.785 Mpc
# ~~~~~~~~~~~~~~~~~~~
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
...
def isDetect(fluxLim=0.0027, beamSize=3.81, diamSNR=0., lumSNR=0.):
    #Assuming flux limit = 2.7 muJy/beam for 1 arcsec beam. Info taken from Laura's findings.
    dist = 0.785 #Mpc,  McConnachie (2005), MNRAS, 356, 979
...
def lightcurve(n0 = 1.0, mej = 2.0, pp=2.5,  epse=0.0, tsnap=500.0,sntype='cc',stop_vel200=False,stop_sblimit=False):
    #Declaring constants for Luminosity Calculation
    if n0 == 0.:
        return ( 0., 0., 0.)

    e51 = mej/1.4  #in units of 10^51 ergs. May need to change this relation. 
    #pp = 2.5
    compf = 4.0
    ff = 0.38
    nei = 1.14
...
####### EPSILON_B AND EPSILON_E ###############################
    #epse = 0.01#4.0e-3
    f = 0.5
    epsCR = 0.06 #Morlino & Caprioli 2012
...
def lightcurve_Full(n0 = 1.0, mej = 2.0, epse=0.0, pp=2.5, sntype='cc', plot_LightCurve=False, plot_Radius = False, plot_EjectaVelocity = False, return_vals = True, stop_vel200 = True, stop_sblimit = False):
    ...
    for ind_t,t in enumerate(tim):
         rad[ind_t], lum[ind_t], vel[ind_t] = lightcurve(n0=n0, mej=mej, epse=epse,pp=pp,tsnap=t,sntype=sntype,stop_vel200=stop_vel200, stop_sblimit=stop_sblimit)
